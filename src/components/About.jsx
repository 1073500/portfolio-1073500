...
function About() {
    return (<div className="p-12 ">
        ...
        <div className="container mx-auto px-4 ">
            ...
            <section className="mb-12 flex-col justify-self-start  gap-4 justify-between">
                <div className="flex flex-col text-start mb-6">
                    <h1 className="mb-6 text-center">Design</h1>
                ...
                <div className="flex flex-col ">
                    <h1 className="mb-6 text-center">Development</h1>
                    <div className="grid grid-cols-2 justify-items-center mb-6">
                        <div
                            className=" w-48 h-48 object-contain filter-[drop-shadow(6px_6px_0px_#177642)] relative">
